...
- [ ] **RBAC-01**: System supports Doctor and Admin roles with distinct permissions
...
- [ ] **META-01**: All clinical records track created_at, created_by, updated_at, updated_by
